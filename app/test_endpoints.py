...
def test_recommendation_cache():
    ...
    # Asegurarnos que hay un pequeño delay para ver la diferencia
    time.sleep(0.1)  # Agregar un pequeño delay
...
def test_performance():
    ...
    assert response.status_code == 200
    assert end_time - start_time < 0.1  # Verificar que responde en menos de 1ms